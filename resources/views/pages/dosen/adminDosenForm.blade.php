                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.dosen.submit') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-input" name="nidn" id="NIDN" placeholder="NIDN">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-input" name="jabatanAkademik" id="exampleInputJabatanAkademik" placeholder="Jabatan Akademik">
                            </div>
                            ...
                            <div class="form-group"><label for="exampleS1">Data S2</label>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control p-input" name="gelars2" id="S2" placeholder="Gelar Akedemik">
                                    <label for="exampleNIP">Asal Perguruan Tinggi S2</label>
                                    <input type="text" class="form-control p-input" name="asals2" id="S2" placeholder="Asal Perguruan Tinggi">
                            ...
                            <div class="form-group"><label for="exampleS1">Data S3</label>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control p-input" name="gelars3" id="S3" placeholder="Gelar Akedemik">
                                    <label for="exampleNIP">Asal Perguruan Tinggi S3</label>
                                    <input type="text" class="form-control p-input" name="asals3" id="S3" placeholder="Asal Perguruan Tinggi">
                                    <label for="exampleNIP">Bidang Keahlian S3</label>
                                    <input type="text" class="form-control p-input" name="keahlians3" id="S3" placeholder="Bidang Keahlian">
                                </div>
                            </div>
                            <div class="form-group">
