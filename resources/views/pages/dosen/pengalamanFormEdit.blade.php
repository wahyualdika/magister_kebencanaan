        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{url('dosen/pengalaman/update/'.$data->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group"><label for="exampleNIP">Kurun Waktu</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-input" value="{{$data->tahun_akhir}}" name="tahunAkhir" id="Tahun Akhir" placeholder="Tahun Akhir">
                            </div>
                        </div>
