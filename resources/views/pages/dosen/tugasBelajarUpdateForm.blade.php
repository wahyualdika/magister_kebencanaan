        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('admin.dosen.tugasBelajarUpdate',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2-multi form-control" name="jenjangPendidikan">
                                <option value="{{$data->jenjang_pendidikan_lanjut}}">Jenjang Pendidikan</option>
                                @for ($i = 1; $i <= 3; $i++)
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-input" value="{{$data->bidang_studi}}" name="bidangStudi" placeholder="Bidang Studi">
                        </div>
                        <div class="form-group">
                            <label for="exampleNIP">Perguruan Tinggi</label>
                            <input type="text" class="form-control p-input" value="{{$data->perguruan_tinggi}}" name="perguruanTinggi" placeholder="Perguruan Tinggi">
                        </div>
                        <div class="form-group">
                            <label for="exampleNIP">Tahun Mulai</label>
                            <input type="text" class="form-control p-input" value="{{$data->tahun_mulai_studi}}" name="tahun" placeholder="Tahun Mulai">
                        </div>
