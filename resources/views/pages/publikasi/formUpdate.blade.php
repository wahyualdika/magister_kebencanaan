        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{url('publikasi/update/'.$datas->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-input" value="{{ $datas->tempat_publikasi }}" name="tempatPublikasi" id="Tempat" placeholder="Dipublikasikan Pada">
                        </div>
                        <div class="form-group">
                            <label for="exampleNIP">Tahun Publikasi</label>
                            <input type="text" class="form-control p-input" value="{{ $datas->tahun }}" name="tahunPublikasi" id="tahun" placeholder="Tahun Publikasi">
                        </div>
                        <div class="form-group">
                            <label for="exampleNIP">Nama Lembaga Sitasi</label>
                            <input type="text" class="form-control p-input" value="{{ $datas->lembaga_sitasi }}" name="lembagaSitasi" id="lembaga" placeholder="Lembaga Sitasi">
                        </div>
                        <div class="form-group"><label for="exampleS1">Tingkat</label>
                            <select class="select2-multi form-control" name="tingkat">
                                <option value="{{ $datas->tingkat->id }}">{{ $datas->tingkat->nama }}</option>
