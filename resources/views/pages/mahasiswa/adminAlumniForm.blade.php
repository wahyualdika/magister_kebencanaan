                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('admin.alumni.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-input" name="judulTesis" id="JudulTesis" placeholder="Judul Tesis">
                        </div>
                        <div class="form-group">
                            <label for="exampleNIP">Tahun Lulus</label>
                            <input type="number" class="form-control p-input" name="tahun" id="TahunLulus" placeholder="Tahun Lulus">
                        </div>
                        <div class="form-group">
