        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('admin.mahasiswa.update',['id' => $data->id])}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-input" value="{{$data->asal_s1}}" name="asalS1" id="S1" placeholder="Asal S1">
                        </div>
                        <div class="form-group">
