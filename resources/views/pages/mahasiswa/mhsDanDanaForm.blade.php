        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('mahasiswa.dana.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group"><label for="exampleS1">Tahun Akademik</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control p-input"name="jumlahMahasiswa" placeholder="Jumlah Mahasiswa">
                            </div>
                            <div class="form-group">
                                <label for="exampleNIP">Jumlah Dana Operasional(Juta Rupiah)</label>
                                <input type="number" class="form-control p-input" name="jumlahDana" placeholder="Jumlah Dana">
                            </div>
                        <div class="form-group">
